...
title: "Roland W-30 — The S-Series Sampling Workstation"
description: "The Roland W-30 is a sampling workstation combining the S-330's 12-bit sampling engine with a 61-key keyboard and built-in sequencer. Specs, history, and relationship to the S-series family."
---

# Roland W-30

The Roland W-30 is a sampling workstation that packages the 12-bit sampling engine from the [S-330](/roland/s330/) and [S-550](/roland/s550/) into an all-in-one keyboard instrument. Released in 1989, it combines a 61-key velocity-sensitive keyboard, the S-series sampler, and a built-in sequencer in a single unit.
...
- **Same mouse support** — the [MU-1 mouse](/roland/s330/mu-1-mouse) and MSX-compatible mice work with the W-30's mouse port
...
- **[Roland S-330](/roland/s330/)** — the same engine in a 1U rack (no keyboard, no sequencer)
- **[Roland S-550](/roland/s550/)** — the same engine in a 2U rack with expanded memory and RGB output
- **[Roland S-770](/roland/s770/)** — the next-generation 16-bit flagship (different architecture)
...
- [Roland S-330 Overview](/roland/s330/) — the compact rack-mount version
- [Roland S-550 Overview](/roland/s550/) — the full-featured rack version
