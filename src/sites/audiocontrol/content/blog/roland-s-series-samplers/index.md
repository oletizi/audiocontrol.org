...
state: published
deskwork:
  id: 1e7a47a4-371d-4ff2-90da-607077af5497
---
...
The [S-330](/roland/s330/) is where most people encounter the S-series today. Its 1U rack form factor, lower original price, and the availability of a [free web editor](/roland/s330/editor) make it the most accessible entry point to 12-bit Roland sampling.
...
The [S-550](/roland/s550/) was Roland's full-featured 12-bit offering. Its advantages over the S-330 are primarily practical rather than sonic:
...
The [W-30](/roland/w30/) takes the 12-bit S-series engine out of the rack and into a keyboard workstation:
...
The [S-770](/roland/s770/) represents Roland's leap to 16-bit sampling:
...
The [Roland MU-1](/roland/s330/mu-1-mouse) is an MSX-compatible mouse manufactured by Mitsumi. It connects to the sampler's 9-pin mouse port and controls a cursor on the external display.

<figure>
  <img src="/images/mu-1.jpg" alt="Roland MU-1 Mouse">
  <figcaption>The Roland MU-1 — an MSX-protocol mouse that works with all S-series samplers</figcaption>
</figure>
...
The [Roland RC-100](/roland/s330/rc-100) is a dedicated control surface with physical buttons and a jog wheel. It connects to the same port as the MU-1 and provides button-driven navigation of the graphical interface.

<figure>
  <img src="/images/rc-100.jpg" alt="Roland RC-100 Remote Controller">
  <figcaption>The Roland RC-100 — a dedicated control surface for S-series samplers</figcaption>
</figure>
...
- **The [audiocontrol.org web editor](/roland/s330/editor)** — a free, browser-based editor that communicates via MIDI SysEx

## The Web Editor

The audiocontrol.org [S-330 web editor](/roland/s330/editor) bypasses the control hardware problem entirely. It communicates directly with the S-330 via MIDI System Exclusive messages — the same protocol Roland included for computer-based editing.

<figure>
  <img src="/images/s330-screenshot.jpg" alt="S-330 Web Editor">
  <figcaption>The audiocontrol.org S-330 web editor running in a browser</figcaption>
</figure>
...
- [Roland S-550 Overview](/roland/s550/) — the full-featured 12-bit rack sampler
- [Roland S-770 Overview](/roland/s770/) — the 16-bit flagship
- [Roland W-30 Overview](/roland/w30/) — the sampling workstation
- [Roland MU-1 Mouse Guide](/roland/s330/mu-1-mouse) — history and alternatives
- [Roland RC-100 Remote Controller Guide](/roland/s330/rc-100) — the dedicated control surface
- [S-330 Web Editor](/roland/s330/editor) — launch the free browser-based editor
- [S-330 Editor Documentation](/docs/roland/samplers/s-330/) — setup and usage guide
