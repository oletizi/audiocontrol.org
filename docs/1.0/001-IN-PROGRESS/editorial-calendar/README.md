...
| 17e | Iterate-loop helpers + disposition stamps + editor UX polish | Complete (PRs #111, #112 merged; further commits on `feature/studio-clearer-buttons`: preview outline-strip, scroll sync, evolution v10-v12) |
