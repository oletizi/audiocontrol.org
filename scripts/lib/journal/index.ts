/*
 * journal/index.ts — directory-backed append-only record store.
 *
 ...
 * workplan.md Phase 15 for the motivation. The editorial-review store
 * (Phase 14c) reuses this module for the same reason.
 */
